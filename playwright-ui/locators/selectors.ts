 ...
 * Mirrors src/banking/locators/selectors.py for structural parity with Python tests.
 */
...
export const ManagerPageSelectors = {
  ...
  add_customer_btn: 'form[ng-submit="addCustomer()"] button',
